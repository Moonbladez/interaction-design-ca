		...
		<Layout>
			...
			<section className={styles.gift_card}>
				...
				<div className={styles.description}>
					Our Gift Cards can be used in any Letha store in the UK & the Republic
					of Ireland,or online. The maximum value that can be added to a gift
					card is £200. The minimum amount is £5.
